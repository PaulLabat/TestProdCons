...
public class TestProdCons extends Simulateur {
	...
	protected void run() throws Exception {
		...
		Tampon t = new ProdCons(nbBuffer, observateur, obst, affichage);
		int i=0;
		...
		for(i=0;i<nbCons;i++)
		{
			Consommateur c = new Consommateur(observateur, tempsMoyenConsommation, deviationTempsMoyenConsommation, t, aleaCons, obst, affichage);
		...
		for(i=0;i<nbProd;i++)
		{
			Producteur p = new Producteur(observateur, tempsMoyenProduction, deviationTempsMoyenProduction, 
					aleaNbreAProduire.next(), t, aleaTempsProd, obst, affichage);
