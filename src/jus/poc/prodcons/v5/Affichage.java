...
public class Affichage {
	...
	public static void printPasLock(_Producteur p){
		if(TestProdCons.affichage == 1){
			System.out.println("Prod " + p.identification());
		}
	}
	
	public static void printPasLock2(_Consommateur c){
		if(TestProdCons.affichage == 1){
			System.out.println("Conso " + c.identification());
		}
	}
}
